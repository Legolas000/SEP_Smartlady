                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs primary">
                                    <li class="active">
                                        <a href="#home-1" data-toggle="tab" aria-expanded="false">
                                            <i class="fa fa-home"></i> Sub Category Management
                                        </a>
                                    </li>
                                    <li class="">
                                ...
                                <div class="tab-content primary">
                                    ...
                                    <body ng-app="myApp" class="ng-cloak">
                                        ...
                                        <%--<div class="menu" ng-controller="CategoryController as ctrltwo">--%>
                                            <%--<select ng-model="myCategory"--%>
                                                    <%--ng-options="category.id as category.catName for category in categories">--%>
                                                <%--<option value="">Select category</option>--%>
                                            <%--</select>--%>
                                            <%--<span>Selected category is {{myCategory.id}}</span>--%>
                                            <%--<span>{{categories[0].id}}</span>--%>
                                                <%--{{testFile()}}--%>
                                        <%--</div>--%>
