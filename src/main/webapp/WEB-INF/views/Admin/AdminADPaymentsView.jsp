                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div ng-controller="MainCtrl as vm">
                                <div style="padding-left: 30px;">
                                    <button type="button" id="addRow" class="btn btn-success" ng-click="addRow($event)">Add Row</button>
                                </div>
                                <br />
                                <div id="serviceGrid"
...
<script src="static/js/controller/adpayment_controller.js"></script>
<script src="static/js/service/adpayment_service.js"></script>
