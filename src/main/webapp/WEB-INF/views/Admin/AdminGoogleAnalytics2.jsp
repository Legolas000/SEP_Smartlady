...
<head>
    ...
    <link href="https://ga-dev-tools.appspot.com/public/css/index.css" rel="stylesheet" type="text/css"/>

    <%--<style>--%>
        <%--.Dashboard-header{border-bottom:1px solid #d4d2d0}.Dashboard-footer,.Dashboard-header{margin:-1.5em -1.5em 1.5em;padding:1.5em}.Dashboard-footer{border-top:1px solid #d4d2d0}.Dashboard--full{max-width:100%}.Dashboard--collapseBottom{padding-bottom:0}@media (min-width:1024px){.Dashboard{padding:2em}.Dashboard-header{margin:-2em -2em 2em;padding:2em}.Dashboard-footer{margin:-2em -2em 2em;padding:1.5em}.Dashboard--collapseBottom{padding-bottom:.5em}}.Dashboard{background:#fff;border:1px solid #d4d2d0;border-radius:4px;max-width:52em;padding:1.5em}--%>
    <%--</style>--%>
                ...
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">SmartLady (All Web Site Data)</h1>
                    ...
                    <div id="view-selector-container"><div class="ViewSelector2">  <div class="ViewSelector2-item">    <label>Account</label>    <select class="FormField"><option selected="" value="86131415">TestGA</option></select>  </div>  <div class="ViewSelector2-item">    <label>Property</label>    <select class="FormField"><option selected="" value="UA-86131415-1">SmartLady</option></select>  </div>  <div class="ViewSelector2-item">    <label>View</label>    <select class="FormField"><option selected="" value="132048718">All Web Site Data</option></select>  </div></div></div>
                </header>
                <div class ="row">
...
<!-- FlexGrid Plugins -->
<script src="static/GAPlugins/flexgrid.js" type="text/javascript"></script>
<link rel="stylesheet" href="static/GAPlugins/flexgrid.css">
