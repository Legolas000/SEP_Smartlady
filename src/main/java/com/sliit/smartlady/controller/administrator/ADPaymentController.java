...
public class ADPaymentController {
	...
	//----------------------------Get All ADPayments----------------------------------
		@RequestMapping(value = "/adpayments/", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/adpayments/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	//-----------------------Create new ADPayment----------------------------------------
		@RequestMapping(value = "/adpayments/", method = RequestMethod.POST)
...
//	        }
	        ...
	        headers.setLocation(ucBuilder.path("/adpayment/{id}").buildAndExpand(adpayment.getID()).toUri());
	        return new ResponseEntity<Void>(headers, HttpStatus.CREATED);
	    }
		
	//--------------------Update a category----------------------------------------------
	@RequestMapping(value = "/adpayments/{id}", method = RequestMethod.PUT)
	...
	//--------------------Delete a category----------------------------------------------
	@RequestMapping(value = "/adpayments/{id}", method = RequestMethod.DELETE)
