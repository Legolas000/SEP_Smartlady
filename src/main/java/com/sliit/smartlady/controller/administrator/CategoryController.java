...
import com.sliit.smartlady.service.administrator.CategoryDAO;
...
public class CategoryController {
	...
	@RequestMapping(value = "admin/categories/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
